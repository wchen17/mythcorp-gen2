/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: f1ca4611420a493c042c2d3e5a9fa203)
// Runtime types generated with workerd@1.20260515.1 2025-04-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	UPLOADS_KV: KVNamespace;
	ASSETS: Fetcher;
	R2_PUBLIC_BASE_URL: "https://REPLACE-with-your-r2-public-domain";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_BASE_URL">> {}
}
